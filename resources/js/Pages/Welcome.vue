<template>
    ...
    <div>
        ...
        <section
            id="skills"
            class="bg-gray-200 text-gray-800 px-72 py-10 h-screen"
        >
        ...
        <section class="bg-gray-600 text-gray-200 px-72 py-10 h-screen">
            ...
            <div class="flex justify-center mt-10">
                <JetButton
                    class="bg-purple-300 rounded font-bold text-sm text-gray-800 hover:bg-indigo-200"
                    >Know More</JetButton
                >
            </div>
        </section>
        ...
        >
            ...
            <div class="flex justify-evenly items-center">
                <Link class="border-b pb-1 pl-1 pr-1 hover:text-gray-50" href=""
                    >Github</Link
                >
                <Link class="border-b pb-1 pl-1 pr-1 hover:text-gray-50" href=""
                    >Twitter</Link
